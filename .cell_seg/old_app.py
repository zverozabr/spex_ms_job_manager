...
#     csvname = qqqqimage.split(".tiff")[0]+'_deepcell.csv'
...
#     pseudoIF = np.stack((Image[channel.index('131Xe')], Image[channel.index('138Ba')],
#                          Image[channel.index('PDPN')], contour, contour3), axis=0)
#
